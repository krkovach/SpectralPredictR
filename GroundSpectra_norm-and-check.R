...
#----Initialize----
set.seed(112345)
setwd("Z:/townsenduser-rw/projects/NEON/kk/Output")
...
sampledata=ABVE_2019_dryspec

cnt=0;for (i in unique(sampledata$Sample)){
  ...
  cnt=cnt+1;print(paste0(cnt,"/",length(unique(sampledata$Sample))))
